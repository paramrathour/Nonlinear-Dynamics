\begin{tikzpicture}[overlay,remember picture]
	...
	\end{scope}
		...
		\draw[ultra thick,gray] ($(current page.center)+(5,2)$) -- ++(0,-3cm) node[midway,left=0.25cm,text width=5cm,align=right,black!75]{{\fontsize{20}{30} \selectfont \bf \textsc{Endterm} \\[10pt] \textsc{Report}}} node[midway,right=0.25cm,text width=6cm,align=left,orange]{{\fontsize{30}{86.4} \selectfont \bf SOS 2020}};
